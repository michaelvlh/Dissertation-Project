...
#$ -N ChromaTest
#$ -o ../Output/chromaLogs.txt  #This is where your output are logged.
#$ -e ../Output/chromaErrors.txt  #This is where your errors are logged.
