...
'''
This is the model using mfccs as features
'''
def mfccTuning():
    print("MFCC FEATURES")
    ...
    for paramID in num_comb:
        ...
        # dependent on the n_mels parameter
        ...
        # set up transform
        # remaining parameters can be tuned as well
        mfcc_transformer = torchaudio.transforms.MFCC(n_mfcc=n_mels, melkwargs={"n_fft": nfft,
                                                                                "n_mels": 128,
                                                                                "hop_length": 512,
                                                                                "mel_scale": "htk",
                                                                                },)
        ...
        # Validation set
        vrealDataset = dataLoad.getData(vRealPath, frac=2, transform=mfcc_transformer)
        vfakeDataset = dataLoad.getData(vFakePath, frac=2, transform=mfcc_transformer)
